		...
		var dialog = self.createDialog({
			...
			yesBtn : {
				...
				click : function(e) {
					...
					var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/index.html' : 'http://api2.map.baidu.com/staticimage',
...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
			...
			yesBtn : {
				...
				click : function(e) {
					var geocoder = win.geocoder,
						...
						url = 'http://maps.googleapis.com/maps/api2/staticmap';
		...
		var iframeHtml = ['<!doctype html><html><head>',
			...
			'</style>',
			'<script src="http://maps.googleapis.com/maps/api2/js?sensor=false&language=' + self.langType + '"></script>',
			'<script>',
			'var map, geocoder;',
			'function initialize() {',
