...
//				$list[$k]['zt']=$this->ddzt($v['ddzt']);//状态
	...
	public function orderDetail(){
		...
		$where['o.id']=$id;
		$orderDB=D("TripOrder o");
		$res = $orderDB->field('o.id,o.order_num,o.freetour_id,o.cash_pay_money,o.pay_price,o.total_price,o.num,o.mobile,o.create_time,o.remark,o.start_date,f.title,o.pay_state,f.line_type')->where($where)->join('Left join asf_freetour f On o.freetour_id=f.id')->find();
