...
class RoleAction extends CommonAction {
    ...
    public function user()
    {
     ...
     //   $where['f']=1;
        $map['status']=1;
		$list2=$user->relation(array('company','department'))->field('id,username,name,company_id,department_id,position_id,status')->where($map)->order('company_id,department_id,id')->select();
