...
<div class="chaxun">
	...
	<li <?php if($_REQUEST[_URL_][1]=='index') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/index')?>">自由行</a></li>
    <li <?php if($_REQUEST[_URL_][1]=='kezhan') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/kezhan')?>">别墅客栈</a></li>
	<li <?php if($_REQUEST[_URL_][1]=='guonei') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/guonei')?>">邮轮</a></li>
	<!--<li <?php if(MODULE_NAME=='guonei' && $_REQUEST[_URL_][4]!='orderflight') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/guonei')?>">邮轮</a></li>-->
    <li <?php if($_REQUEST[_URL_][1]=='diy') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/diy')?>">私人定制</a></li>
	<li <?php if(MODULE_NAME=='Iflight' && $_REQUEST[_URL_][5]!='guonei') echo "class='active'"; ?> ><a href="<?php echo U('/Iflight/orderflight')?>">机票预订</a></li>
    <!--<li <?php if(MODULE_NAME=='diy' && $_REQUEST[_URL_][3]!='guonei') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/diy')?>">私人定制</a></li>-->
	<!-- <li <?php if($_REQUEST[_URL_][4]=='orderflight') echo "class='active'"; ?> ><a href="<?php echo U('/Iflight/orderflight')?>">机票预订</a></li>-->
    <!--  <li <?php if(MODULE_NAME=='kezhan') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/kezhan')?>">别墅客栈</a></li> -->
	<!-- <li <?php if($_REQUEST[_URL_][1]=='kezhan') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/kezhan')?>">别墅客栈</a></li> -->
    ...
    <h2>选择品悦的理由</h2>
       <ul>
        ...
        <ul id="iFc" class="i-f-c">
            <li class="curr">
                <a class="more" href="<?php echo U('/freetour/index');?>">更多周末趣游路线》</a>
                <div class="one">
                    <a href="<?php echo U('/freetour/index');?>"><img src="__PUBLIC__/images/index-3.jpg" alt="" /></a>
                </div>
                <?php if(is_array($list["kezhan_line"])): $i = 0; $__LIST__ = $list["kezhan_line"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
                    <a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/uploads<?php echo ($vo[images][0]); ?>" alt="" /></a>
                    <p><a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></p>
                    <p><span>￥<?php echo ($vo["price"]); ?>起</span> <?php if($vo.dcity_name): echo ($vo["dcity_name"]); ?>出发<?php endif; ?></p>
    ...
    <!-- 独家定制 -->
        ...
        <ul class="i-f-c">
            <li class="curr">
                <a class="more" href="<?php echo U('/freetour/index');?>">更多主题活动的推荐》</a>
                <?php if(is_array($list["qinzi_line"])): $i = 0; $__LIST__ = $list["qinzi_line"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
                    <a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/uploads<?php echo ($vo[images][0]); ?>" alt="" /></a>
                    <p><a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></p>
                    <p><span>￥<?php echo ($vo["price"]); ?>起</span><?php echo ($vo["dcity_name"]); ?></p>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
     ...
     <div id="iF" class="i-f wd980">
        ...
        <ul id="iFc" class="i-f-c">
            <li class="curr">
                <a class="more" href="<?php echo U('/freetour/index');?>">更多美国的路线》</a>
                <div class="one">
                    <a href="<?php echo U('/freetour/index');?>"><img src="__PUBLIC__/images/index-2.jpg" alt="" /></a>
                </div>
                <?php if(is_array($list["guoji_line"])): $i = 0; $__LIST__ = $list["guoji_line"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
                    <a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/uploads<?php echo ($vo[images][0]); ?>" alt="" /></a>
                    <p><a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></p>
                    <p><span>￥<?php echo ($vo["price"]); ?>元</span> <?php echo ($vo["dcity_name"]); ?>出发</p>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <!-- 独家定制 -->
        ...
        <ul class="i-f-c">
            <li class="curr">
                <a class="more" href="<?php echo U('/freetour/index');?>">更多自由行的路线》</a>
                <?php if(is_array($list["dujia_line"])): $i = 0; $__LIST__ = $list["dujia_line"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div>
                    <a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>"><img src="__PUBLIC__/uploads<?php echo ($vo[images][0]); ?>" alt="" /></a>
                    <p><a href="<?php echo U('/freetour/detail/',array('id'=>$vo['id']));?>" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a></p>
                    <p><span>￥<?php echo ($vo["price"]); ?>元</span><?php echo ($vo["dcity_name"]); ?>出发</p>
                </div><?php endforeach; endif; else: echo "" ;endif; ?>
