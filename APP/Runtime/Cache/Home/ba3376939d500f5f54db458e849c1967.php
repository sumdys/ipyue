...
<div class="chaxun">
    ...
    <li <?php if(MODULE_NAME=='kezhan' && $_REQUEST[_URL_][2]!='guonei') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/kezhan')?>">别墅客栈</a></li>
	<li <?php if($_REQUEST[_URL_][2]=='guonei') echo "class='active'"; ?> ><a href="<?php echo U('/freetour/guonei')?>">邮轮</a></li>
