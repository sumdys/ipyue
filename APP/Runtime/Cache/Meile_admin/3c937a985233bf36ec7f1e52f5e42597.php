	...
	<form method="post" enctype="multipart/form-data" action="__URL__/edit/navTabId/__MODULE__-index" class="pageForm required-validate" onsubmit="return  validateCallback(this,dialogAjaxDone)" novalidate="novalidate">
		<div class="pageFormContent" layoutH="58">
            ...
            <div class="unit">
                ...
                <input type="radio" name="info[line_type]" value="7"  <?=$info['line_type']==7?'checked':''?>/>独家资源
                <input type="radio" name="info[line_type]" value="8"  <?=$info['line_type']==8?'checked':''?>/>跟团游
                <input type="radio" name="info[line_type]" value="9"  <?=$info['line_type']==9?'checked':''?>/>高端游
                <input type="radio" name="info[line_type]" value="10"  <?=$info['line_type']==10?'checked':''?>/>亲子游学
                <input type="radio" name="info[line_type]" value="11"  <?=$info['line_type']==11?'checked':''?>/>景点门票
            </div>
            <div class="unit">
                <label>行程：</label>
