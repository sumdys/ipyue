    ...
    <div class="pageContent">
        ...
        <table class="list" width="100%" layoutH="116">
            ...
            <tr>
                ...
                <th width="100">年月</th>
                <th width="50">推广订单数</th>
                <th width="50" >推广者数</th>
                <th width="80" >佣金金额小计</th>
                <th width="100">佣金状态</th>
                <th width="100">操作</th>
            </tr>
            </thead>
            <tbody>
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_node" rel="<?php echo ($vo['id']); ?>">
                    ...
                    <td><?php echo ($vo["num1"]); ?></td>
                    <td><?php echo ($vo["create_time"]); ?></td>
                    <td>

                    </td>
                    <td>
                        <a href="__URL__/order_list/end_time/<?php echo ($vo["order_time"]); ?>">查看订单</a>
                        <!--<a href="__URL__/edit/id/<?php echo ($vo['id']); ?>" target="dialog" rel="edit" width="890" height="400">编辑</a>-->
                        <!--<a href="__URL__/changeStatus/status/2/id/<?php echo ($vo['id']); ?>/navTabId/__MODULE__-index" target="navTabTodo" title="你确定要审核不通过吗？">不通过</a>-->
                    </td>
