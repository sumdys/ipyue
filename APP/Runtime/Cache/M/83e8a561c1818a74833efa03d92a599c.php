<?php if (!defined('THINK_PATH')) exit();?>﻿<div id="header"><a href="<?php echo U('/');?>">
...
<table cellspacing="0" cellpadding="0" width="" align="center" border="0" style="margin-top: 50px;">
    <tbody>
    <tr>
    ...
    <tr>
        <td align="middle">
            <center>
                <table cellspacing="0" cellpadding="0" width="" border="0"  style="margin-bottom: 10px;">
                    <tbody>
                    <tr>
                        <td width="6">
