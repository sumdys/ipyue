		...
		<div id="pullrefresh" class="mui-content mui-scroll-wrapper">
			<div class="mui-scroll">
				...
				<dl id="nav">
					...
					<dt><a href="<?php echo U('/Freetour/index');?>/type/4"><img src="__PUBLIC__/mobile/images/icon/58c8fa3a98564_thumb.png" height="58%"><p>别墅客栈</p></a></dt>
					<dt><a href="<?php echo U('/Freetour/index');?>/type/5"><img src="__PUBLIC__/mobile/images/icon/58c8fa5df35a2_thumb.png" height="58%"><p>豪华邮轮</p></a></dt>
					<dt><a href="<?php echo U('/Freetour/index');?>/type/7"><img src="__PUBLIC__/mobile/images/icon/58c8fa194dbfd_thumb.png" height="58%"><p>独家资源</p></a></dt>
				</dl>
				<dl id="nav">
					<dt><a href="<?php echo U('/Freetour/index');?>/type/8">
						<img src="__PUBLIC__/mobile/images/icon/gentuan.png" height="58%">
						<p>跟团游</p>
					</a>
					</dt>

					<dt><a href="<?php echo U('/Freetour/index');?>/type/9"><img src="__PUBLIC__/mobile/images/icon/guanduan.png" height="58%"><p>高端游</p></a></dt>
					<dt><a href="<?php echo U('/Freetour/index');?>/type/10"><img src="__PUBLIC__/mobile/images/icon/xlyy.png" height="58%"><p>亲子游学</p></a></dt>
					<dt><a href="<?php echo U('/Freetour/index');?>/type/11"><img src="__PUBLIC__/mobile/images/icon/menpiao.png" height="58%"><p>景点门票</p></a></dt>
				</dl>
				<dl id="entrance" class="mui-table-view mui-table-view-chevron">
					<?php if(is_array($list["tj_line"])): $i = 0; $__LIST__ = $list["tj_line"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dt>
							<a href="<?php echo U('freetour/detail');?>/id/<?php echo ($vo["id"]); ?>" class="c01">
								<img class="images_c01" src="__PUBLIC__/uploads<?php echo ($vo[images][0]); ?>">

								<div class="ft-tj-d">
									<div style="float: left;margin: 5px;font-size: 1.2em;width: 98%;">
										<font color="#7A7A7A"><B><?php echo ($vo["title"]); ?></B></font><br><font color="#EE2C2C"><B><?php echo ($vo["price"]); ?>RMB</B></font>&nbsp;&nbsp;&nbsp;<font color="#C5C1AA"><del><?php echo ($vo["old_price"]); ?>RMB</del></font><b class="liji">立即预订</b>
									</div>
								</div>
								<!--<h3>旅游路线推荐</h3>-->
...
//		var cells = document.body.querySelectorAll('.mui-table-view-cell');
		$.ajax({
			type: "POST",
			url: "<?php echo U('/Freetour/ajaxList');?>",
			...
			success: function(res){
				...
				if(data.status){
					$.each(data.contact,function(k,v){
						var li = document.createElement('dt');
//						li.className = 'mui-table-view-cell';
						li.innerHTML = '<a href="<?php echo U("freetour/detail");?>/id/'+ v.id+'" class="c01">'+
