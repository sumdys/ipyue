...
<body>
    <div align="center">
        <ul>
            <li style="background-color:#FF7F24"><a href="<?php echo U('/wx/jsapi');?>">JSAPI支付</a></li>
...
<script>
    var option :{
        title : '田涧小苑【2号别墅】',
        desc :  "田涧小苑 2号别墅",
        link : "view-source:http://m.ipyue.com/freetour/detail/id/108",
        imgUrl : "/Public/Uploads/day_170702/201707021324247524.jpg"
    },
    /*
     * 注意：
