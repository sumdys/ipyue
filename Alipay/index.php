                                ...
                                <tr>
                                    <td align="center" valign="top" bgcolor="#FFFFEE"><table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14">
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top" align="left"><input type="text" name="order_no" maxlength="55" size="20" readonly="readonly" value="<?php echo $out_trade_no ?>" font style="color:#000000;font-size:14px;"></td>
                                            </tr>
                                            <tr>
